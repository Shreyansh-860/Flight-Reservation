package com.shreyansh.flightreservation.util;
...
public class EmailUtil {
	@Value("${com.shreyansh.flightreservation.itinerary.email.body}")
	private String EMAIL_BODY = "Please find your Itinerary attached.";

	@Value("${com.shreyansh.flightreservation.itinerary.email.subject}")
